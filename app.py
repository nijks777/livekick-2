#!/usr/bin/env python3
"""
AIRecruiters LiveKit Agent - VAD-ONLY IMPLEMENTATION (NO TURN DETECTOR)
...
def run_agent():
    try:
        ...
        print(f"❌ VAD-only agent startup failed: {e}")
        exit(1)
...
@app.route("/")
def health():
    return "LiveKit Agent is running!", 200

if __name__ == "__main__":
    print("🚀 AIRecruiters LiveKit Agent (VAD-ONLY MODE)")
    print("=" * 60)
